...
<main class="form-signin col-sm-3 m-auto text-center p-4">
  <form class="pt-5" action="<?=site_url('admin/dashboard/login');?>" method="POST">
    <img class="" src="<?=base_url('assets/img/staf-only.png'); ?>" alt="" width="200">
    <p class="mb-3 fw-normal">Verifikasi diri anda</p>
