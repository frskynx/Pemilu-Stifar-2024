...
<div class="container">
  <div class="my-5 text-center">
      <h3 class="mb-0">Halaman Surat Suara Wakil</h3>
          ...
          <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
              ...
              <div class="modal-body text-center">
                <p>Silahkan tekan tombol <strong class="text-info">Lanjutkan</strong> jika <b>0<?=$i?></b> adalah pilihan yang benar. Tekan tombol <strong class="text-secondary">Batal</strong> untuk menutup jendela ini.</p>
                  <form action="<?=site_url('welcome/createSuara');?>" class="text-center" method="post">
                    <input name="nim" value="<?=$this->session->userdata('nim')?>" hidden>
                    <input name="id_admin" value="<?=$this->session->userdata('id')?>" hidden>
                    <input name="id_calon" value="<?=$this->session->userdata('id_calon')?>" hidden>
                    <input name="id_calon_wakil" value="<?=$row['id_calon']; ?>" hidden>
